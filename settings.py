...
SECRET_KEY = 'n8o-a!2dw56*#g)^yuer+$wk*6tnz*ajb252foqk-_mo6%n2#i'
...
THUMBNAIL_ALIASES = {
    '': {
        'avatar': {'size': (150, 150), 'scale': True},
        'large': {'size': (450, 400), 'scale':True},
    },
}
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'shopcart.utils.context_processors.shopcart',
)
